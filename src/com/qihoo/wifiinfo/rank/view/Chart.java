...
import com.qihoo.wifiinfo.rank.data.DataSet;
import com.qihoo.wifiinfo.rank.data.Entry;
import com.qihoo.wifiinfo.rank.interfaces.OnChartValueSelectedListener;
import com.qihoo.wifiinfo.rank.utils.Highlight;
import com.qihoo.wifiinfo.rank.utils.Legend;
import com.qihoo.wifiinfo.rank.utils.MarkerView;
...
public abstract class Chart extends View implements AnimatorUpdateListener {
    ...
    protected void prepareMatrix() {
        ...
        Log.d("jiabin", "mDeltaX:"+mDeltaX+" mDeltaY:"+mDeltaY);
        // setup all matrices
