package com.qihoo.wifiinfo.rank.view;

import java.text.DecimalFormat;
import java.util.ArrayList;

import com.qihoo.wifiinfo.rank.data.BarLineScatterCandleData;
import com.qihoo.wifiinfo.rank.data.ChartData;
import com.qihoo.wifiinfo.rank.data.Entry;
import com.qihoo.wifiinfo.rank.data.filter.Approximator;
import com.qihoo.wifiinfo.rank.interfaces.OnDrawListener;
import com.qihoo.wifiinfo.rank.listener.BarLineChartTouchListener;
import com.qihoo.wifiinfo.rank.utils.Highlight;
import com.qihoo.wifiinfo.rank.utils.Legend.LegendPosition;
import com.qihoo.wifiinfo.rank.utils.LimitLine;
import com.qihoo.wifiinfo.rank.utils.PointD;
import com.qihoo.wifiinfo.rank.utils.SelInfo;
import com.qihoo.wifiinfo.rank.utils.Utils;
import com.qihoo.wifiinfo.rank.utils.XLabels;
import com.qihoo.wifiinfo.rank.utils.XLabels.XLabelPosition;
import com.qihoo.wifiinfo.rank.utils.YLabels;
import com.qihoo.wifiinfo.rank.utils.YLabels.YLabelPosition;
...
public abstract class BarLineChartBase extends Chart {
    ...
    protected void calculateOffsets() {
        ...
        float scaleX = (float) ((getWidth() - mOffsetLeft - mOffsetRight) / mDeltaY);
        float scaleY = (float) ((getHeight() - mOffsetBottom - mOffsetTop) / mDeltaX);

        Matrix val = new Matrix();
        //val.postTranslate(0, -mYChartMin);
        val.postTranslate(-mYChartMin, 0);
